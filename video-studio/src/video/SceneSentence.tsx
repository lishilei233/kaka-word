...
export function SceneSentence({ english, chinese, width, vocabulary = [], chineseOpacity = 1 }: { english: string; chinese: string; width: number; vocabulary?: string[]; chineseOpacity?: number }) {
    let size = 22;
